...
$(function() {
  ...
  if($("#home-cover, #maintenance-wrapper").exists()) {
	...
	*/
	...
	if(UrlParams && "list" in UrlParams && "viewer" in UrlParams) {
		var $item = $(PF.obj.listing.selectors.list_item, PF.obj.listing.selectors.content_listing_visible)[UrlParams.viewer == "next" ? "first" : "last"]();
		CHV.fn.listingViewer.open($item);
	}
